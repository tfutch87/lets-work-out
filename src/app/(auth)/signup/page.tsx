...
export default function SignupPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-violet-950 via-slate-900 to-slate-950 flex items-center justify-center px-4">
        ...
        <Card className="bg-white/5 border-white/10 text-white">
          <CardHeader>
            ...
            <CardDescription className="text-slate-400 text-center">
              Free forever. Start training smarter today.
            </CardDescription>
          </CardHeader>
